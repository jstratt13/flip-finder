...
| `09-category-fit.mjs` | eBay result category as a relevance signal on top of the judge: labelled accuracy, and what it drops from sample 2 |
| `10-trimming.mjs` | Comp outlier trimming: today's 10–90% band vs dropping one price at each end, and what each does to spread and confidence |
